            ...
            for y, node in enumerate(row):
                ...
                for m, movement in enumerate(delta):
                    ...
                    if node_is_valid(x2, y2):
                        ...
                        #~ # Debug
                        #~ print 'movement:', delta_name[m]
                        #~ print '--- valid node', x2, y2, v_success, '---'
                        #~ print '- left:', x + delta[(m + 1) % 4][0], y + delta[(m + 1) % 4][1], v_left
                        #~ print '- right:', x + delta[(m - 1) % 4][0], y + delta[(m - 1) % 4][1]
                        #~ print 'v2:', v2
