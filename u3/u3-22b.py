...
scat = pylab.plot(myrobot.x, myrobot.y, s=50, c='r', marker='o')
steps = 20
for i in range(steps):
  
  myrobot = myrobot.move(0.02, 0.5)
  Z = myrobot.sense()
  ...
  yplot = []
  for particle in p:
    xplot.append(particle.x)
    yplot.append(particle.y)
  plt.scatter(myrobot.x, myrobot.y, s=50, c='r', marker='o')
